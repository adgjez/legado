...
@Composable
internal fun AiVideoProviderManageScreen(
    providers: List<AiVideoProviderConfig>,
    currentProviderId: String,
    onBack: () -> Unit,
    onAdd: () -> Unit,
    onOpenProvider: (AiVideoProviderConfig) -> Unit,
    providerActions: (AiVideoProviderConfig) -> List<AppManagementMenuAction>
) {
    ...
    CompositionLocalProvider(
        ...
        Surface(
            ...
            Column(
                ...
                AiVideoProviderTopBar(onBack = onBack)
                Text(
                    text = stringResource(R.string.ai_video_provider_manage_summary),
...
@Composable
private fun AiVideoProviderTopBar(onBack: () -> Unit) {
    val palette = rememberAppManagementPalette()
    Row(
        modifier = Modifier
            .fillMaxWidth()
        ...
        Text(
            text = stringResource(R.string.ai_video_provider_manage),
...
@Composable
private fun AiVideoProviderCard(
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            Column(modifier = Modifier.weight(1f)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    if (current) {
                        AiVideoProviderCurrentBadge(palette)
                    }
                }
...
@Composable
private fun AiVideoProviderCurrentBadge(palette: AppManagementPalette) {
    Surface(
        shape = RoundedCornerShape(palette.miuix.actionRadius ?: 12.dp),
...
@Composable
private fun AiVideoProviderEmptyCard() {
    val palette = rememberAppManagementPalette()
    AppManagementCard(
        palette = palette,
