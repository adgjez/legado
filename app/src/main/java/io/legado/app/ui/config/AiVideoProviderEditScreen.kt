...
internal fun AiVideoProviderEditScreen(
    ...
    onVideoUrlJsonPathChange: (String) -> Unit,
    statusJsonPath: String,
    onStatusJsonPathChange: (String) -> Unit,
    doneStatusValue: String,
    onDoneStatusValueChange: (String) -> Unit,
    ...
    CompositionLocalProvider(
        ...
        Surface(
            ...
            Column(
                ...
                AiVideoProviderEditTopBar(onBack = onBack)
                Column(
                    modifier = Modifier
                        .weight(1f)
                        .fillMaxWidth()
...
@Composable
private fun AiVideoProviderEditTopBar(onBack: () -> Unit) {
    val style = rememberAppDialogStyle()
    Row(
        modifier = Modifier
            .fillMaxWidth()
